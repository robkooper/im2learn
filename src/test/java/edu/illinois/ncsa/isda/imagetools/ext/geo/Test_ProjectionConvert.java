...
import edu.illinois.ncsa.isda.imagetools.core.geo.projection.Ellipsoid;
...
public class Test_ProjectionConvert {
	...
	public ImageObject RasterConvert(ImageObject testObject) throws GeoException, IOException, ImageException {
		...
		edu.illinois.ncsa.isda.imagetools.core.geo.projection.Projection oldProj = (edu.illinois.ncsa.isda.imagetools.core.geo.projection.Projection) testObject.getProperty(ImageObject.GEOINFO);
		edu.illinois.ncsa.isda.imagetools.core.geo.Projection newProj = null;
		try {
		...
		TiePoint tp = null;
		if (newProj.getType().equals(edu.illinois.ncsa.isda.imagetools.core.geo.Projection.ProjectionType.Geographic)) {
		...
		edu.illinois.ncsa.isda.imagetools.core.geo.Projection targetProj = edu.illinois.ncsa.isda.imagetools.core.geo.Projection.getProjection("Albers Equal Area Conic", edu.illinois.ncsa.isda.imagetools.core.geo.Projection.ProjectionType.Albers, geogcs,
				param, null, unit);
	...
	public void VerifyRasterCorners_toAndFromEarthConvert(ImageObject testObject) throws GeoException, IOException, ImageException {
		...
		param.put(edu.illinois.ncsa.isda.imagetools.core.geo.Projection.STANDARD_PARALLEL_2, "45.5");
		param.put(edu.illinois.ncsa.isda.imagetools.core.geo.Projection.LATITUDE_OF_ORIGIN, "23.0");
		param.put(edu.illinois.ncsa.isda.imagetools.core.geo.Projection.LONGITUDE_OF_ORIGIN, "0.0");
		param.put(edu.illinois.ncsa.isda.imagetools.core.geo.Projection.CENTRAL_MERIDIAN, "-96");
	...
	public void VerifyRasterCorners_toAndFromModelConvert(ImageObject testObject) throws GeoException, IOException, ImageException {
		...
		edu.illinois.ncsa.isda.imagetools.core.geo.Projection targetProj = edu.illinois.ncsa.isda.imagetools.core.geo.Projection.getProjection("Albers", edu.illinois.ncsa.isda.imagetools.core.geo.Projection.ProjectionType.Albers, geogcs, param, tp, unit);
	...
	public boolean Test_RasterConvert(String OutFileName) throws GeoException, IOException, ImageException {
		 ...
		 * (ncsa.im2learn.core.geo.projection.Projection)test.getProperty(ImageObject.GEOINFO); //
		 * ncsa.im2learn.core.geo.projection.AlbersEqualAreaConic geo = //
		 * (ncsa.im2learn.core.geo.projection.AlbersEqualAreaConic)test.getProperty(ImageObject.GEOINFO)
		...
		// class !!!
		edu.illinois.ncsa.isda.imagetools.core.geo.projection.Projection geo = new edu.illinois.ncsa.isda.imagetools.core.geo.projection.Projection();
