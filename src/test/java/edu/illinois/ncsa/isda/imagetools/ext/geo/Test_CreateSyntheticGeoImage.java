...
public class Test_CreateSyntheticGeoImage {
	...
	public void CreateImage1(String OutFileName) throws GeoException, IOException, ImageException {
		...
		edu.illinois.ncsa.isda.imagetools.core.geo.Projection targetProj = setTargetProjection(testObject);
	 ...
	 */
	public edu.illinois.ncsa.isda.imagetools.core.geo.Projection setTargetProjection(ImageObject testObject) throws GeoException, IOException, ImageException {
	...
	public void LoadAndCopy(String InFileName, String OutFileName) throws GeoException, IOException, ImageException {
		...
		// add georeferencing information
		edu.illinois.ncsa.isda.imagetools.core.geo.projection.Projection targetProj = (edu.illinois.ncsa.isda.imagetools.core.geo.projection.Projection) inputObject.getProperty(ImageObject.GEOINFO);
